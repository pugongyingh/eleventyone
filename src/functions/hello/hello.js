...
//=> Apple, Orange, Pear
    ...
    //let questionss = $resultsPage('div[class="suanming_s"]').find('suanming_c_1').html();
	 let questionss = $resultsPage('div[class="suanming_s"]').children('div[class="suanming_c_1"]').slice(0,5).html();
	  questionss = questionss + $resultsPage('div[class="suanming_s"]').children('div[class="suanming_c_1"]').slice(1,5).html();
	  questionss = questionss + $resultsPage('div[class="suanming_s"]').children('div[class="suanming_c_1"]').slice(2,5).html();
